...
console.log('International rates setup');
...
wallet.add(payment2);
console.log(`Received payment of ${payment2.toLocaleString()} in CAD`);
console.log(`My wallet has ${wallet.toLocaleString()}`);

const spending = Money(1000, CAD);
console.log(`Spending ${spending}`);
console.log(
  `Coverting to USD. ${spending} -> ${exchange.exchangeWith(spending, USD)}`
);
